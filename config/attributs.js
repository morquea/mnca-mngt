let attributs = {
    ...
    'iot/services': {
        ...
        'readwrite': {
            ...
            'delete': ['entity_type', 'attributes', 'lazy', 'commands', 'internal_attributes', 'static_attributes']
        },
    ...
    'iot/devices': {
        'readonly': {
            'update': ['device_id', 'service', 'service_path', 'entity_name', 'entity_type', 'lazy']
        },
        'readwrite': {
            'update': ['attributes', 'commands', 'static_attributes']
        },
